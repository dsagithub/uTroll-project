...
function createFriends(u, vote) {
	...
	if (!vote) {
		...
		tdt.setAttribute('class', 'btn btn-primary btn-danger btn-xs');// modifica
																		// atributo
																		// de la
																		// celda
...
function createPendingFriends(u) {
	...
	var tdt = tr.insertCell(1);// crea una celda y la inserta en la fila
	tdt.setAttribute('class', 'btn btn-primary btn-success btn-xs');// modifica
																	// atributo
																	// de la
																	// celda
	tdt.appendChild(document.createTextNode('Acepta'));// crea un textnode y lo
														// añade a la celda
...
function createSearchedFriends(u, n) {
	...
	tdt.setAttribute('class', 'btn btn-primary btn-warning btn-xs');// modifica
																	...
																	// de la
																	// celda
	tdt.appendChild(document.createTextNode('Enviar petición de amistad'));// crea
																			// un
																			// textnode
																			// y lo
																			// añade
